                ...
                child: Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        SizedBox(height: 30,),
                        FadeInUp(duration: Duration(milliseconds: 1700), child: Text("Belum punya akun?", style: TextStyle(color: Colors.grey),)),
                        SizedBox(height: 1,),
                        Row(
                          children: <Widget>[
                            Expanded(child: 
                            FadeInUp(duration: Duration(milliseconds: 1700), child: TextButton(onPressed: () {
                              Navigator.of(context)
                                ...
                                .then((value) => (value));
                            }, child: Text("Daftar Sekarang", style: TextStyle(color: Colors.lightBlue)))),
                            )
                          ],
                        )
                      ],
